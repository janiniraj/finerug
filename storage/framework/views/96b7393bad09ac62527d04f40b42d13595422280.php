                            ...
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        ...
                                        <?php echo e(Form::open(['route' => 'frontend.checkout.add_guest_address', 'id' => 'user_billing', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files' => true])); ?>


                                            <?php echo e(Form::hidden('type', 'billing')); ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse">
                                        <div class="panel-body">
                                        <?php echo e(Form::open(['route' => 'frontend.checkout.add_guest_address', 'id' => 'user_shipping', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files' => true])); ?>

										
                                                <?php echo e(Form::hidden('type', 'shipping')); ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <a href="<?php echo e(route('frontend.checkout.before-payment')); ?>" type="submit" class="btn btn-success btn-lg before-payment" style="width:100%;">Pay
                                            </a>
                                            <br/>

			...
			<div class="col-md-8 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<?php echo e(Form::open(['route' => 'frontend.auth.login.post', 'class' => 'form-horizontal', 'id' => 'login-form', 'style' => 'display:block;'])); ?>
								...
								<?php echo e(Form::open(['route' => 'frontend.auth.register.post-ajax', 'class' => 'form-horizontal', 'id' => 'register-form', 'style' => 'display:none;'])); ?>
								...
								<?php echo e(Form::open(['route' => 'frontend.auth.password.email.post', 'class' => 'form-horizontal', 'id' => 'forgot_password_form', 'style' => 'display:none;'])); ?>

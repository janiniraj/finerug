    ...
    <div class="top-bar px-lg-4">
        <div class="container-fluid">
            <div class="top-wrap">
				...
				<?php echo e(Form::open(['method' => 'GET', 'class' => 'navbar-form', 'url' => route('frontend.product.product-by-type')])); ?>
                    ...
                    <div class="top-btns">
                    	<ul class="list-unstyled m-0 ">
							<li class="list-inline-item">
								<?php if(Auth::check()): ?>
									<?php echo e(link_to_route('frontend.auth.logout', 'Logout', [], ['class' => 'login' ])); ?>

								<?php else: ?>
                                    <a href="<?php echo e(route('frontend.login')); ?>" class="login">Login</a>
									
								<?php endif; ?>
							</li>
                        	<li class="list-inline-item"><a href=""><i class="far fa-user-circle"></i> <span>My Account</span></a></li>
                            <li class="list-inline-item"><a href="<?php echo e(route('frontend.checkout.cart')); ?>"><i class="fas fa-shopping-cart"></i> <span class="count"><?php echo e($cartCount); ?></span></a></li>
                        </ul>	
                    </div>
                </div>
        	...
        	<div class="row">
            	...
            	<nav class="nav-menu">
                	<ul class="list-unstyled m-0 menu">
                    	<li><a href="<?php echo e(route('frontend.product.product-by-type', ['type' => 'rug'])); ?>" >Rug</a>
                                    	...
                                    	<div class="row">
                                            <div class="col-lg-4">
                                                <div class="sub-wrap">
                                                    ...
                                                    <?php if(count($helper->rugCategoryList) > 0): ?>
                                                    <ul class="list-unstyled m-0">
                                                    	<?php $__currentLoopData = $helper->rugCategoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'/'.$single->category.'?type=rug'); ?>"><?php echo e($single->category); ?></a></li>
                                          ...
                                          <div class="col-lg-4">
                                                <div class="sub-wrap">
                                                    ...
                                                    <ul class="list-unstyled m-0">
                                                    	...
                                                    	<?php $__currentLoopData = $helper->rugShapeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&shape='.$single->shape); ?>"><?php echo e($single->shape); ?></a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                            </div>
                                       <!--
                                            <div class="col-lg-4">
                                                <div class="sub-wrap">
                                                    <h3>Color</h3>
                                                    <ul class="list-unstyled m-0">
                                                    	<?php echo e($helper->rugColorList); ?>

                   	                                <?php $__currentLoopData = $helper->rugColorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&color='.$color->id); ?>"><?php echo e($color->name); ?></a></li>
                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
										...
										-->
                                            ...
                                            <div class="col-lg-4">
                                                <div class="sub-wrap">
                                                    <h3>Collections </h3>
                                                    <ul class="list-unstyled m-0">
                                                    	 <?php $__currentLoopData = $helper->rugCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&collection='.$single->id); ?>"><?php echo e($single->subcategory); ?></a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="sub-wrap">
                                                    <h3>Size </h3>
                                                    <ul class="list-unstyled m-0">
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=2x3'); ?>">2x3</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=3x5'); ?>">3x5</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=4x6'); ?>">4x6</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=5x8'); ?>">5x8</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=6x9'); ?>">6x9</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=8x10'); ?>">8x10</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=9x12'); ?>">9x12</a></li>
                                                        <li><a href="<?php echo e(route('frontend.product.product-by-type').'?type=rug&size=10x14'); ?>">10x14</a></li>
                                                    </ul>
                                                </div>
                                            </div>
	...
	<div class="modal fade" id="register-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="loginmodal-container">
			  ...
			  <?php echo e(Form::open(['route' => 'frontend.auth.register.post-ajax', 'class' => 'form-horizontal', 'id' => 'headerRegister'])); ?>
	...
	<div class="modal fade" id="mailing-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="loginmodal-container">
			  ...
			  <?php echo e(Form::open(['route' => 'frontend.page.mailing-submit', 'class' => 'form-horizontal', 'id' => 'mailingSubmitForm'])); ?>
	...
	<div class="modal fade" id="forgetpassword-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="loginmodal-container">
				...
				<h1><?php echo e(trans('labels.frontend.passwords.reset_password_box_title')); ?></h1><br>

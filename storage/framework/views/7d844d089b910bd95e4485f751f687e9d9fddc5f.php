...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="<?php echo e(route('admin.categories.index')); ?>"><i class="fa fa-list-ul"></i> <?php echo e(trans('menus.backend.categories.all')); ?></a></li>
    <li><a href="<?php echo e(route('admin.categories.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(trans('menus.backend.categories.create')); ?></a></li>
  </ul>
</div>
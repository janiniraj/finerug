 ...
 <div class="container-fluid" id="header">
        <section class="slider" id="headerSlider">
            <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($slide->type == 'youtubevideo'): ?>
                    <!--<div>
                        <iframe class="youtube-video" src="https://www.youtube.com/embed/<?php echo e($slide->youtubevideo_id); ?>" frameborder="0" allowfullscreen></iframe>
                    </div>--> 
                <?php else: ?>
                    <div>
                        <img height='350px' src="<?php echo e(URL::to('/').'/img/sliders/'.$slide->image); ?>">
                        <?php if($slide->title): ?>
                            <div class="slide-caption">
                                <a href="<?php echo e(url('/').'/'.$slide->url); ?>">
                                <h1 class="title"><?php echo e($slide->title); ?></h1>
                                </a>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="item">
                	...
                	<?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<?php else: ?>
							...
							<div class="col-md-7 d-none d-md-block"><img src="<?php echo e(URL::to('/').'/img/sliders/'.$slide->image); ?>" alt=""/></div>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show" id="shop_by_categories">
				...
				<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if(file_exists(public_path().'/img/category/'.$category->icon) and $category->icon): ?>
                	<div class=" col-lg-3 col-sm-6">
                    	<div class="fade-grid">
                        	<a href="<?php echo e(route('frontend.product.index', $category->category)); ?>">
                        		<figure><img src="<?php echo e(url('/').'/img/category/'.$category->icon); ?>" alt=""/></figure>
              ...
              <div class="tab-pane fade" id="shop_by_collections">
				...
				<?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if(file_exists(public_path().'/img/subcategory/'.$collection->icon) and $collection->icon): ?>
					<?php $row++;// ?>
                	<div class="col-md-<?php echo e($row==3 ? '3' : '3'); ?>">
                    	<div class="fade-grid">
                        	<a href="<?php echo e(route('frontend.product.product-by-type').'?collection='.$collection->id); ?>">
                        		<figure><img src="<?php echo e(url('/').'/img/subcategory/'.$collection->icon); ?>"  alt=""/></figure>
                                <h2><?php echo e($collection->subcategory); ?></h2>
                            </a>
                        </div>
                    </div>
					<?php endif; ?>

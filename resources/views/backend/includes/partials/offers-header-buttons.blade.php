...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.orders.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.orders.all')}}</a></li>
    <li><a href="{{route('admin.orders.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.orders.create')}}</a></li>
  </ul>
</div>
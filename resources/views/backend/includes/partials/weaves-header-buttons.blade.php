<!--Action Button-->
    @if(Active::checkUriPattern('admin/weaves'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.weaves.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.weaves.all')}}</a></li>
    <li><a href="{{route('admin.weaves.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.weaves.create')}}</a></li>
  </ul>
</div>
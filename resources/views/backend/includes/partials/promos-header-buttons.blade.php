<!--Action Button-->
    @if(Active::checkUriPattern('admin/promos'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.promos.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.promos.all')}}</a></li>
    <li><a href="{{route('admin.promos.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.promos.create')}}</a></li>
  </ul>
</div>
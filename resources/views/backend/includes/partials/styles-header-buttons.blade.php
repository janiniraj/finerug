<!--Action Button-->
    @if(Active::checkUriPattern('admin/styles'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.styles.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.styles.all')}}</a></li>
    <li><a href="{{route('admin.styles.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.styles.create')}}</a></li>
  </ul>
</div>
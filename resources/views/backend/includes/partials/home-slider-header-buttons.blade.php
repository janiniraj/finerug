<!--Action Button-->
    @if(Active::checkUriPattern('admin/home-slider'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.home-slider.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.home_slider.all')}}</a></li>
    <li><a href="{{route('admin.home-slider.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.home_slider.create')}}</a></li>
  </ul>
</div>
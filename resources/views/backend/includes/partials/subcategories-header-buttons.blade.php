...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.subcategories.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.subcategories.all')}}</a></li>
    <li><a href="{{route('admin.subcategories.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.subcategories.create')}}</a></li>
  </ul>
</div>
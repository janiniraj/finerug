...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.emails.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.emails.all')}}</a></li>
    <li><a href="{{route('admin.emails.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.emails.create')}}</a></li>
  </ul>
</div>
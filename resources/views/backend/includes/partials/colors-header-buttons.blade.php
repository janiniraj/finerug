<!--Action Button-->
    @if(Active::checkUriPattern('admin/colors'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.colors.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.colors.all')}}</a></li>    
    <li><a href="{{route('admin.colors.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.colors.create')}}</a></li>
  </ul>
</div>
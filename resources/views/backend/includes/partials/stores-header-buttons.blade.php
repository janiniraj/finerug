<!--Action Button-->
    @if(Active::checkUriPattern('admin/stores'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.stores.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.stores.all')}}</a></li>
    <li><a href="{{route('admin.stores.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.stores.create')}}</a></li>
  </ul>
</div>
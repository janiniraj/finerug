...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.categories.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.categories.all')}}</a></li>
    <li><a href="{{route('admin.categories.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.categories.create')}}</a></li>
  </ul>
</div>
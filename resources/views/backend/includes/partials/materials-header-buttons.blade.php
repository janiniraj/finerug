<!--Action Button-->
    @if(Active::checkUriPattern('admin/materials'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.materials.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.materials.all')}}</a></li>
    <li><a href="{{route('admin.materials.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.materials.create')}}</a></li>
  </ul>
</div>
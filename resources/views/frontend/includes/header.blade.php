                ...
                {{ Form::close() }}
                    ...
                    <div class="top-btns">
                    	<ul class="list-unstyled m-0 ">
                        	...
                        	<li class="list-inline-item"><a href="{{ route('frontend.account.my-account') }}"><i class="far fa-user-circle"></i> <span>My Account</span></a></li>
        	...
        	<div class="row">
                ...
                <nav class="nav-manu">
                	<ul class="list-unstyled m-0 menu">
                        ...
                        <li><a href="{{ route('frontend.contact.get-estimate') }}" class="menu-active">Get Free Estimate</a></li>
                    </ul>
                </nav>
            </div>
        </div>

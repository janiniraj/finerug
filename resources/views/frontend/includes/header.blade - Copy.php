        ...
        <div class="container-fluid">
            <div class="top-wrap">
                ...
                {{ Form::close() }}
                    ...
                    <div class="help-number">Helpline No: <strong><a href="tel:1800-000-000"> noble</a></strong></div>
                    ...
                    <div class="top-btns">
                    	<ul class="list-unstyled m-0 ">
                            ...
                            <li class="list-inline-item"><a href=""><i class="fas fa-shopping-cart"></i> <span>Cart</span></a></li>
                        </ul>	
                    </div>
                </div>
        	...
        	<div class="row">
            	...
            	<nav class="nav-menu">
                	<ul class="list-unstyled m-0 menu">
                        ...
                        <li><a href="{{ route('frontend.product.product-by-type', ['type' => 'furniture']) }}">Furniture</a>
